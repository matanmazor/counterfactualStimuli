...
plan.random_first = 0; %for now just let structured block occur 1st
% if binornd(1,0.5) 
%     plan.random_first = 1;
% end
...
% structured.visibility = -1.7+0.45*[linspace(-1,1,60)', -linspace(-1,1,60)';...
%    -linspace(-1,1,60)', linspace(-1,1,60)'];
...
>>>>>>> 7c6b6d840db96b878228ce87483508b8754d04d2
end